<%@ Page Title="" Language="C#" MasterPageFile="~/views/reports/asset/asset.master" AutoEventWireup="true" CodeBehind="custom.aspx.cs" Inherits="Toems_FrontEnd.views.reports.asset.custom" %>
...
<asp:Content runat="server" ContentPlaceHolderID="subsubHelp">
    <p>A custom asset report will export a list of custom assets and attributes based on the criteria provided.  The value can use a wildcard value of % before or after the string.  You can also select if you want to include Archived Assets in the results.  Finally, a group by option is available for any selected field.</p>
</asp:Content>