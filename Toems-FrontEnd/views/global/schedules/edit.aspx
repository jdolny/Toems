<%@ Page Title="" Language="C#" MasterPageFile="~/views/global/schedules/schedules.master" AutoEventWireup="true" CodeBehind="edit.aspx.cs" Inherits="Toems_FrontEnd.views.global.schedules.edit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="DropDownActionsSub2" Runat="Server">
    <li><asp:LinkButton ID="buttonUpdateSchedule" runat="server" OnClick="buttonUpdateSchedule_OnClick" Text="Update Schedule" CssClass="main-action"/></li>
</asp:Content>
   ...
   <div class="size-4 column">
    ...
    <br class="clear"/>
     ...
     <div class="size-setting column hidden-check">
            <asp:CheckBox ID="chkActive" runat="server" ClientIDMode="Static"></asp:CheckBox>
