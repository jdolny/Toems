<%@ Page Title="" Language="C#" MasterPageFile="~/views/admin/pxeboot/pxeboot.master" AutoEventWireup="true" CodeBehind="searchbootentry.aspx.cs" Inherits="Toems_FrontEnd.views.admin.pxeboot.searchbootentry" %>
<asp:Content ID="Content1" ContentPlaceHolderID="TopBreadCrumbSub2" runat="server">
     <li><a href="<%= ResolveUrl("~/views/admin/pxeboot/searchbootentry.aspx") %>?level=2">Search Custom Boot Entries</a></li>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="SubNavTitle_Sub2" runat="server">
    Search Custom Boot Entries
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="SubContent2" runat="server">
      <script type="text/javascript">
        $(document).ready(function() {
            $('#searchbootentry').addClass("nav-current");
    ...
    <asp:GridView ID="gvEntries" runat="server" AllowSorting="True" DataKeyNames="Id" AutoGenerateColumns="False" CssClass="Gridview" AlternatingRowStyle-CssClass="alt">
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="Id" DataNavigateUrlFormatString="~/views/admin/pxeboot/editbootentry.aspx?entryId={0}&level=2" Text="View" ItemStyle-CssClass="chkboxwidth"/>
    ...
    <div id="confirmbox" class="confirm-box-outer">
        <div class="confirm-box-inner">
            <h4>
                <asp:Label ID="lblTitle" runat="server" Text="Delete The Selected Boot Entries?"></asp:Label>
            </h4>
