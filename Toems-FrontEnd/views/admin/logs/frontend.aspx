<%@ Page Title="" Language="C#" MasterPageFile="~/views/admin/logs/logs.master" AutoEventWireup="true" CodeBehind="frontend.aspx.cs" Inherits="Toems_FrontEnd.views.admin.logs.frontend" %>
...
<asp:Content runat="server" ContentPlaceHolderID="subsubHelp">
    <p>Displays logs for the web ui.</p>
</asp:Content>