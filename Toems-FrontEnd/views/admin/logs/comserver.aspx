<%@ Page Title="" Language="C#" MasterPageFile="~/views/admin/logs/logs.master" AutoEventWireup="true" CodeBehind="comserver.aspx.cs" Inherits="Toems_FrontEnd.views.admin.logs.comserver" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SubContent2" Runat="Server">
    <script type="text/javascript">
        $(document).ready(function() {
            $('#comserver').addClass("nav-current");
        });
    </script>
