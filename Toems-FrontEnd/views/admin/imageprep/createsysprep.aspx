<%@ Page Title="" Language="C#" MasterPageFile="~/views/admin/imageprep/imageprep.master" AutoEventWireup="true" CodeBehind="createsysprep.aspx.cs" ValidateRequest="False" Inherits="Toems_FrontEnd.views.admin.imageprep.createsysprep" %>
<asp:Content ID="Content1" ContentPlaceHolderID="TopBreadCrumbSub2" runat="server">
     <li><a href="<%= ResolveUrl("~/views/admin/imageprep/createsysprep.aspx") %>?level=2">Create Sysprep File</a></li>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="DropDownActionsSub2" runat="server">
     ...
     <li><asp:LinkButton ID="buttonUpdate" runat="server" OnClick="buttonUpdate_Click" Text="Create Sysprep File" CssClass="main-action" OnClientClick="update_click()" /></li>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="SubContent2" runat="server">
     <script type="text/javascript">
        $(document).ready(function() {
            $('#createsysprep').addClass("nav-current");
        });
     </script>
