<%@ Page Title="" Language="C#" MasterPageFile="~/views/admin/wolrelays/wolrelays.master" AutoEventWireup="true" CodeBehind="create.aspx.cs" Inherits="Toems_FrontEnd.views.admin.wolrelays.create" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="DropDownActionsSub2" Runat="Server">
   <li><asp:LinkButton ID="buttonAddRelay" runat="server" OnClick="buttonAddRelay_OnClick" Text="Add Relay" CssClass="main-action" /></li>
</asp:Content>
