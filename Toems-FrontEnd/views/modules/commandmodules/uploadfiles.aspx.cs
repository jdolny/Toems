    ...
    public partial class uploadfiles : BasePages.Modules
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (!baseurl.EndsWith("/"))
                    baseurl = baseurl + "/";
                moduleGuid = CommandModule.Guid;
                moduleId = CommandModule.Id.ToString();
                PopulateGrid();
        ...
        protected void UploadButton_OnClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Response.Redirect("~/views/modules/commandmodules/uploadfiles.aspx?commandModuleId=" + CommandModule.Id);
            }
        ...
        {
            var listOfFiles = Call.UploadedFileApi.GetModuleFiles(CommandModule.Guid);
