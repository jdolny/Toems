...
{
    public partial class commandmodule : BasePages.MasterBaseMaster
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            CommandModule = ModulesBasePage.CommandModule;
        ...
        {
            lblTitle.Text = "Archive " + CommandModule.Name + "?";
        ...
        {
            lblTitle.Text = "Delete " + CommandModule.Name + "?";
        ...
        protected void buttonConfirm_OnClick(object sender, EventArgs e)
        {
            ...
            {
                case "delete":
                    result = ModulesBasePage.Call.CommandModuleApi.Delete(CommandModule.Id);
                    actionLabel = "Deleted";
                    break;
                case "archive":
                    result = ModulesBasePage.Call.ModuleApi.Archive(CommandModule.Id, EnumModule.ModuleType.Command);
            ...
            if (result.Success)
            {
                PageBaseMaster.EndUserMessage = "Successfully " + actionLabel + " Module: " + CommandModule.Name;
