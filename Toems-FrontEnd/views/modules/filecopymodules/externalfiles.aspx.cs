...
namespace Toems_FrontEnd.views.modules.filecopymodules
{
    public partial class externalfiles : BasePages.Modules
    {
        ...
        {
            var listOfFiles = Call.ExternalDownloadApi.GetForModule(FileCopyModule.Guid);
        ...
        protected void btnDelete_OnClick(object sender, EventArgs e)
        {
            ...
            if (control != null)
            {
                ...
                if (dataKey != null)
                {
                    ...
                    Response.Redirect("~/views/modules/filecopymodules/externalfiles.aspx?fileCopyModuleId=" + FileCopyModule.Id);
                }
            }
        }
        ...
        protected void btnReDownload_OnClick(object sender, EventArgs e)
        {
            ...
            var activeResult = Call.ModuleApi.IsModuleActive(FileCopyModule.Guid);
        ...
        protected void buttonDownload_OnClick(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                foreach (GridViewRow row in gvExternalFiles.Rows)
                {
                    ...
                    fd.ModuleGuid = FileCopyModule.Guid;
