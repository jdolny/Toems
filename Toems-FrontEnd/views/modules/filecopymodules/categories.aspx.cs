...
namespace Toems_FrontEnd.views.modules.filecopymodules
{
    public partial class categories : BasePages.Modules
    {
        ...
        private void BindGrid()
        {
            ...
            var moduleCategories = Call.ModuleApi.GetModuleCategories(FileCopyModule.Guid);
        ...
        protected void buttonUpdate_OnClick(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow row in gvCategories.Rows)
            {
                ...
                modCategory.ModuleGuid = FileCopyModule.Guid;
            ...
            if (list.Count == 0)
            {
                var result = Call.ModuleCategoryApi.Delete(FileCopyModule.Guid);
