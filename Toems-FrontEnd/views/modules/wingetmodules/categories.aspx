<%@ Page Title="" Language="C#" MasterPageFile="~/views/modules/wingetmodules/wingetmodule.master" AutoEventWireup="true" CodeBehind="categories.aspx.cs" Inherits="Toems_FrontEnd.views.modules.wingetmodules.categories" %>
<asp:Content runat="server" ContentPlaceHolderID="TopBreadCrumbSub2">
    <li><%= WingetModule.Name %></li>
    <li>Categories</li>
</asp:Content>
...
<asp:Content runat="server" ContentPlaceHolderID="subsubHelp">
    Categories operate like tags and allow you organize your modules and filter by them on the search page. Categories can be defined in Global Properties->Categories
</asp:Content>