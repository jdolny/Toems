<%@ Page Title="" Language="C#" MasterPageFile="~/views/modules/scriptmodules/scriptmodule.master" AutoEventWireup="true" CodeBehind="search.aspx.cs" Inherits="Toems_FrontEnd.views.modules.scriptmodules.search" %>
    ...
    <asp:GridView ID="gvModules" runat="server" AllowSorting="True" DataKeyNames="Id" OnSorting="gridView_Sorting" AutoGenerateColumns="False" CssClass="Gridview" AlternatingRowStyle-CssClass="alt">
        <Columns>
            ...
            <asp:BoundField DataField="Name" HeaderText="Name" SortExpression="Name" ItemStyle-CssClass="width_200"></asp:BoundField>
             <asp:BoundField DataField="ScriptType" HeaderText="Type" SortExpression="ScriptType" />
        </Columns>
        <EmptyDataTemplate>
            No Script Modules Found
        </EmptyDataTemplate>
    </asp:GridView>
