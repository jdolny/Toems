<%@ Page Title="" Language="C#" MasterPageFile="~/views/modules/scriptmodules/scriptmodule.master" AutoEventWireup="true" CodeBehind="general.aspx.cs" ValidateRequest="False" Inherits="Toems_FrontEnd.views.modules.scriptmodules.general" %>
<asp:Content runat="server" ContentPlaceHolderID="TopBreadCrumbSub2">
    <li><%= ScriptModule.Name %></li>
    <li>General</li>
</asp:Content>
...
<p>There are 5 script type options, Powershell, VbScript, Batch, ImagingClientBash, and ImagingClientPowershell.  The first 3 are used with Toec and can be assigned to Policies.  The last 2 are
    ...
    Environment, select ImagingClientPowershell.  The script contents must be for the appropriate script type.</p><h5><span style="color: #ff9900;"><strong>Arguments:</strong></span></h5>
