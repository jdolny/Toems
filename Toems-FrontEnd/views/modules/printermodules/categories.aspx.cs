...
namespace Toems_FrontEnd.views.modules.printermodules
{
    public partial class categories : BasePages.Modules
    {
        ...
        private void BindGrid()
        {
            ...
            var moduleCategories = Call.ModuleApi.GetModuleCategories(PrinterModule.Guid);
        ...
        protected void buttonUpdate_OnClick(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow row in gvCategories.Rows)
            {
                ...
                modCategory.ModuleGuid = PrinterModule.Guid;
            ...
            if (list.Count == 0)
            {
                var result = Call.ModuleCategoryApi.Delete(PrinterModule.Guid);
