<%@ Page Title="" Language="C#" MasterPageFile="~/views/modules/printermodules/printermodule.master" AutoEventWireup="true" CodeBehind="categories.aspx.cs" Inherits="Toems_FrontEnd.views.modules.printermodules.categories" %>
<asp:Content runat="server" ContentPlaceHolderID="TopBreadCrumbSub2">
    <li><%= PrinterModule.Name %></li>
    <li>Categories</li>
</asp:Content>
...
<asp:Content runat="server" ContentPlaceHolderID="subsubHelp">
    <p>Categories operate like tags and allow you organize your modules and filter by them on the search page.  Categories can be defined in Global Properties->Categories</p>
</asp:Content>