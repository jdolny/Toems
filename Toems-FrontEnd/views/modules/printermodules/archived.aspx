<%@ Page Title="" Language="C#" MasterPageFile="~/views/modules/printermodules/printermodule.master" AutoEventWireup="true" CodeBehind="archived.aspx.cs" Inherits="Toems_FrontEnd.views.modules.printermodules.archived" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="DropDownActionsSub2" Runat="Server">
    <li><asp:LinkButton ID="btnDelete" runat="server" OnClick="btnDelete_OnClick" Text="Delete Selected Modules" CssClass="main-action"/></li>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SubContent2" Runat="Server">
    ...
    <asp:GridView ID="gvModules" runat="server" AllowSorting="True" DataKeyNames="Id" OnSorting="gridView_Sorting" AutoGenerateColumns="False" CssClass="Gridview" AlternatingRowStyle-CssClass="alt">
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="Id" DataNavigateUrlFormatString="~/views/modules/printermodules/general.aspx?printerModuleId={0}" Text="View" ItemStyle-CssClass="chkboxwidth"/>
            <asp:BoundField DataField="Id" HeaderText="Id" SortExpression="Id" Visible="False"/>
            <asp:BoundField DataField="Name" HeaderText="Name" SortExpression="Name" ItemStyle-CssClass="width_200"></asp:BoundField>
            <asp:BoundField DataField="NetworkPath" HeaderText="Path" SortExpression="NetworkPath" ItemStyle-CssClass="width_200"/>
             <asp:BoundField DataField="Action" HeaderText="Action" SortExpression="Action" ItemStyle-CssClass="width_200"/>
             <asp:BoundField DataField="IsDefault" HeaderText="Default" SortExpression="IsDefault" ItemStyle-CssClass="width_200" />
            <asp:TemplateField>
                <ItemTemplate>
