...
namespace Toems_FrontEnd.views.modules.softwaremodules
{
    public partial class externalfiles : BasePages.Modules
    {
        ...
        {
            var listOfFiles = Call.ExternalDownloadApi.GetForModule(SoftwareModule.Guid);
        ...
        protected void btnDelete_OnClick(object sender, EventArgs e)
        {
            ...
            if (control != null)
            {
                ...
                if (dataKey != null)
                {
                    ...
                    Response.Redirect("~/views/modules/softwaremodules/externalfiles.aspx?softwareModuleId=" + SoftwareModule.Id);
                }
            }
        }
        ...
        protected void btnReDownload_OnClick(object sender, EventArgs e)
        {
            ...
            var activeResult = Call.ModuleApi.IsModuleActive(SoftwareModule.Guid);
        ...
        protected void buttonDownload_OnClick(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                foreach (GridViewRow row in gvExternalFiles.Rows)
                {
                    ...
                    fd.ModuleGuid = SoftwareModule.Guid;
