<%@ Page Title="" Language="C#" MasterPageFile="~/views/modules/softwaremodules/softwaremodule.master" AutoEventWireup="true" CodeBehind="uploadfiles.aspx.cs" Inherits="Toems_FrontEnd.views.modules.softwaremodules.uploadfiles" %>
                    ...
                    var uploader = new qq.FineUploader({
                        ...
                        request: {
                            ...
                            params: {
                                ...
                                moduleId: moduleId,
                                moduleType: "1" //moduletype enum software = 1
                            }
                        },
...
<asp:Content runat="server" ContentPlaceHolderID="SubSubHelp">
    <p>The upload files page is where you add or remove your msi, msp,or mst files to / from the software module.  Uploading software module files will only accept extensions of .msi, .msp, or .mst.  
        Only a single msi can be uploaded, but unlimited msp and mst files can be added.  When file uploads or deletions are completed, the software module's command and arguments and automatically updated.  
        Finally, if you are using multiple Client Communication Servers, you will be prompted to replicate the files to all servers when uploading is complete.  You must stay on the upload files page while 
        files are uploading, navigating to a different page will stop the uploads.</p>
</asp:Content>