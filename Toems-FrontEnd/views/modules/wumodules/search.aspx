<%@ Page Title="" Language="C#" MasterPageFile="~/views/modules/wumodules/wumodule.master" AutoEventWireup="true" CodeBehind="search.aspx.cs" Inherits="Toems_FrontEnd.views.modules.wumodules.search" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SubContent2" Runat="Server">
    ...
    <asp:GridView ID="gvModules" runat="server" AllowSorting="True" DataKeyNames="Id" OnSorting="gridView_Sorting" AutoGenerateColumns="False" CssClass="Gridview" AlternatingRowStyle-CssClass="alt">
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="Id" DataNavigateUrlFormatString="~/views/modules/wumodules/general.aspx?wuModuleId={0}" Text="View" ItemStyle-CssClass="chkboxwidth"/>
        ...
        <EmptyDataTemplate>
            No Windows Update Modules Found
        </EmptyDataTemplate>
    </asp:GridView>
