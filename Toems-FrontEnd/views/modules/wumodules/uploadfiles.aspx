<%@ Page Title="" Language="C#" MasterPageFile="~/views/modules/wumodules/wumodule.master" AutoEventWireup="true" CodeBehind="uploadfiles.aspx.cs" Inherits="Toems_FrontEnd.views.modules.wumodules.uploadfiles" %>
                    ...
                    var uploader = new qq.FineUploader({
                        ...
                        request: {
                            ...
                            params: {
                                ...
                                moduleId: moduleId,
                                moduleType: "5" //moduletype enum windowsupdate = 5
                            }
                        },
...
<asp:Content runat="server" ContentPlaceHolderID="subsubHelp">
    <p>The upload files page is where you add or remove your msu or cab files to / from the software module. Uploading windows update module files will only accept extensions of .msu or .cab. Only two files can be uploaded and they must both be either .msu or .cab, you cannot have one of each.  If you are using multiple Client Communication Servers, you will be prompted to replicate the files to all servers when uploading is complete. Finally, you must stay on the upload files page while files are uploading, navigating to a different page will stop the uploads.</p>
</asp:Content>
