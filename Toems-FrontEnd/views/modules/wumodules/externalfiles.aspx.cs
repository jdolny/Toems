...
namespace Toems_FrontEnd.views.modules.wumodules
{
    public partial class externalfiles : BasePages.Modules
    {
        ...
        {
            var listOfFiles = Call.ExternalDownloadApi.GetForModule(WuModule.Guid);
        ...
        protected void btnDelete_OnClick(object sender, EventArgs e)
        {
            ...
            if (control != null)
            {
                ...
                if (dataKey != null)
                {
                    ...
                    Response.Redirect("~/views/modules/wumodules/externalfiles.aspx?wuModuleId=" + WuModule.Id);
                }
            }
        }
        ...
        protected void btnReDownload_OnClick(object sender, EventArgs e)
        {
            ...
            var activeResult = Call.ModuleApi.IsModuleActive(WuModule.Guid);
