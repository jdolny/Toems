    ...
    public partial class uploadfiles : BasePages.Modules
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (!baseurl.EndsWith("/"))
                    baseurl = baseurl + "/";
                moduleGuid = WuModule.Guid;
                moduleId = WuModule.Id.ToString();
                PopulateGrid();
        ...
        protected void UploadButton_OnClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Response.Redirect("~/views/modules/wumodules/uploadfiles.aspx?wuModuleId=" + WuModule.Id);
            }
        ...
        {
            var listOfFiles = Call.UploadedFileApi.GetModuleFiles(WuModule.Guid);
            gvModules.DataSource = listOfFiles;
            gvModules.DataBind();

            lblTotal.Text = listOfFiles.Count() + " Files(s)";
        }
