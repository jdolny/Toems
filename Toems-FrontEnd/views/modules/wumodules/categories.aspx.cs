...
namespace Toems_FrontEnd.views.modules.wumodules
{
    public partial class categories : BasePages.Modules
    {
        ...
        private void BindGrid()
        {
            ...
            var moduleCategories = Call.ModuleApi.GetModuleCategories(WuModule.Guid);
        ...
        protected void buttonUpdate_OnClick(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow row in gvCategories.Rows)
            {
                ...
                modCategory.ModuleGuid = WuModule.Guid;
            ...
            if (list.Count == 0)
            {
                var result = Call.ModuleCategoryApi.Delete(WuModule.Guid);
