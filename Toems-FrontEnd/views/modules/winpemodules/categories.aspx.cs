...
namespace Toems_FrontEnd.views.modules.winpemodules
{
    public partial class categories : BasePages.Modules
    {
        ...
        private void BindGrid()
        {
            ...
            var moduleCategories = Call.ModuleApi.GetModuleCategories(WinPeModule.Guid);
        ...
        protected void buttonUpdate_OnClick(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow row in gvCategories.Rows)
            {
                ...
                modCategory.ModuleGuid = WinPeModule.Guid;
            ...
            if (list.Count == 0)
            {
                var result = Call.ModuleCategoryApi.Delete(WinPeModule.Guid);
