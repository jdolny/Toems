<%@ Page Title="" Language="C#" MasterPageFile="~/views/modules/messagemodules/messagemodule.master" AutoEventWireup="true" CodeBehind="categories.aspx.cs" Inherits="Toems_FrontEnd.views.modules.messagemodules.categories" %>
<asp:Content runat="server" ContentPlaceHolderID="TopBreadCrumbSub2">
    <li><%= MessageModule.Name %></li>
    <li>Categories</li>
</asp:Content>
