<%@ Page Title="" Language="C#" MasterPageFile="~/views/modules/messagemodules/messagemodule.master" AutoEventWireup="true" CodeBehind="archived.aspx.cs" Inherits="Toems_FrontEnd.views.modules.messagemodules.archived" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SubContent2" Runat="Server">
    ...
    <asp:GridView ID="gvModules" runat="server" AllowSorting="True" DataKeyNames="Id" OnSorting="gridView_Sorting" AutoGenerateColumns="False" CssClass="Gridview" AlternatingRowStyle-CssClass="alt">
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="Id" DataNavigateUrlFormatString="~/views/modules/messagemodules/general.aspx?messageModuleId={0}" Text="View" ItemStyle-CssClass="chkboxwidth"/>
            <asp:BoundField DataField="Id" HeaderText="Id" SortExpression="Id" Visible="False"/>
            <asp:BoundField DataField="Name" HeaderText="Name" SortExpression="Name" ItemStyle-CssClass="width_200"></asp:BoundField>
             <asp:BoundField DataField="Title" HeaderText="Title" ItemStyle-CssClass="width_200" />
            <asp:TemplateField>
                <ItemTemplate>
