<%@ Page Title="" Language="C#" MasterPageFile="~/views/modules/sysprepmodules/sysprepmodule.master" AutoEventWireup="true" CodeBehind="archived.aspx.cs" Inherits="Toems_FrontEnd.views.modules.sysprepmodules.archived" %>
    ...
    <asp:GridView ID="gvModules" runat="server" AllowSorting="True" DataKeyNames="Id" OnSorting="gridView_Sorting" AutoGenerateColumns="False" CssClass="Gridview" AlternatingRowStyle-CssClass="alt">
        <Columns>
            ...
            <asp:BoundField DataField="Name" HeaderText="Name" SortExpression="Name" ItemStyle-CssClass="width_200"></asp:BoundField>
             <asp:BoundField DataField="OpeningTag" HeaderText="Tag"  ItemStyle-CssClass="width_200" />
            <asp:TemplateField>
                <ItemTemplate>
