...
namespace Toems_FrontEnd.views.modules.sysprepmodules
{
    public partial class categories : BasePages.Modules
    {
        ...
        private void BindGrid()
        {
            ...
            var moduleCategories = Call.ModuleApi.GetModuleCategories(SysprepModule.Guid);
        ...
        protected void buttonUpdate_OnClick(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow row in gvCategories.Rows)
            {
                ...
                modCategory.ModuleGuid = SysprepModule.Guid;
            ...
            if (list.Count == 0)
            {
                var result = Call.ModuleCategoryApi.Delete(SysprepModule.Guid);
