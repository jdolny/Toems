<%@ Page Title="" Language="C#" MasterPageFile="~/views/assets/attributes/attributes.master" AutoEventWireup="true" CodeBehind="edit.aspx.cs" Inherits="Toems_FrontEnd.views.global.attributes.edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SubContent2" Runat="Server">
    ...
    <br class="clear"/>
            ...
            <div class="size-5 column">
            <asp:DropDownList ID="ddlUsageType" runat="server" CssClass="ddlist" ClientIDMode="Static" Enabled="False">
            </asp:DropDownList>
            </div>
