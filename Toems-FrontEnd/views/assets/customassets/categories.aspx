<%@ Page Title="" Language="C#" MasterPageFile="~/views/assets/customassets/customassets.master" AutoEventWireup="true" CodeBehind="categories.aspx.cs" Inherits="Toems_FrontEnd.views.assets.customassets.categories" %>
...
<asp:Content runat="server" ContentPlaceHolderID="subsubHelp">
    <p>Categories operate like tags and allow you to organize your assets and filter by them on the search page. Categories can be defined in Global Properties->Categories.</p>
</asp:Content>
