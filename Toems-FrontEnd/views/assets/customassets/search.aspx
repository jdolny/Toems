<%@ Page Title="" Language="C#" MasterPageFile="~/views/assets/customassets/customassets.master" AutoEventWireup="true" CodeBehind="search.aspx.cs" Inherits="Toems_FrontEnd.views.assets.customassets.search" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="DropDownActionsSub2" Runat="Server">
    <li><asp:LinkButton runat="server" ID="btnArchive" Text="Archive Selected" CssClass="main-action" OnClick="btnArchive_OnClick"></asp:LinkButton></li>
...
<asp:Content runat="server" ContentPlaceHolderID="subsubHelp">
    <p>Displays all Custom Assets that have been added to Theopenem.  Multiple assets can be deleted or archived from this page.  Filtering options include:</p>
<ul>
	<li>By Asset Type</li>
	<li>By Category</li>
	<li>By Limit</li>
