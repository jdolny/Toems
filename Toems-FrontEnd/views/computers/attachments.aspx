<%@ Page Title="" Language="C#" MasterPageFile="~/views/computers/computers.master" AutoEventWireup="true" CodeBehind="attachments.aspx.cs" Inherits="Toems_FrontEnd.views.computers.attachments" %>
...
<asp:Content runat="server" ContentPlaceHolderID="subHelp">
    <p>Allows you to add any files to the computer, for later viewing.  An example usage could be a purchase order.</p>
</asp:Content>
