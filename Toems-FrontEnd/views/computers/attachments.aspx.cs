...
{
    public partial class attachments : BasePages.Computers
    {
        protected string token { get; set; }
        protected string baseurl { get; set; }
        protected string attachmentGuid { get; set; }
        protected string computerId { get; set; }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                computerId = ComputerEntity.Id.ToString();
                BindGrid();
            }
        ...
        protected void ErrorButton_OnClick(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/views/computers/attachments.aspx?computerId=" + ComputerEntity.Id);
        }

        private void BindGrid()
        {
            gvAttachments.DataSource = Call.ComputerApi.GetAttachments(ComputerEntity.Id);
