<%@ Page Title="" Language="C#" MasterPageFile="~/views/imagingtasks/imagingtasks.master" AutoEventWireup="true" CodeBehind="active.aspx.cs" Inherits="Toems_FrontEnd.views.imagingtasks.active" %>
...
<asp:Content runat="server" ContentPlaceHolderID="subHelp">
  Displays all active tasks that have been started by the current user. Administrators see tasks created from all users. Individual tasks can also be cancelled from this page. 
    Administrators have an extra action on this page called Cancel All Tasks. This can be useful to clean things up. It clears all multicast processes, database entries, and boot files for all tasks.
</asp:Content>
