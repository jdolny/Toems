<%@ Page Title="" Language="C#" MasterPageFile="~/views/images/images.master" AutoEventWireup="true" CodeBehind="general.aspx.cs" Inherits="Toems_FrontEnd.views.images.general" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="DropDownActionsSub" runat="Server">
    <li><asp:LinkButton ID="btnSubmit" runat="server" Text="Update Image" Onclick="btnSubmit_Click" CssClass="main-action"/></li>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SubContent" runat="Server">
  <script type="text/javascript">
    ...
    <div class="size-4 column">
     ...
     <div class="size-setting column hidden-check">
            <asp:CheckBox ID="chkEnabled" runat="server" ClientIDMode="Static"></asp:CheckBox>
         <label for="chkEnabled">Toggle</label>
        </div>
...
<p>Specifies if the image can be used directly from the Client Imaging OS menu, instead of a web based task.</p>
        <h5><span style="color: #ff9900;">Enabled:</span></h5>
<p>Only enabled images can be deployed.  If you want to keep an image around but not let anyone deploy it, then disable it.</p>
</asp:Content>
