...
{
    public class ProvisionAuth : Attribute, IAuthenticationFilter
    {
        ...
        public Task AuthenticateAsync(HttpAuthenticationContext context, CancellationToken cancellationToken)
        {
            ...
            Logger.Debug($"ID: {logId} - Received provision auth request");
            ...
            var serverKeyBytes =
                Encoding.ASCII.GetBytes(
                    new EncryptionServices().DecryptText(
                        ServiceSetting.GetSettingValue(SettingStrings.ProvisionKeyEncrypted)));
