...
namespace Toems_Common.DbUpgrades
{
    class _148 : IDbScript
    {
        ...
        {
            return
@"UPDATE `toems_version` SET `expected_app_version` = '1.4.8.0', `database_version` = '1.4.8.0', `expected_toecapi_version` = '1.4.8.0', `latest_client_version` = '1.4.5.0' WHERE (`toems_version_id` = '1');
