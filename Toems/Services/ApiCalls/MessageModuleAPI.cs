...
namespace Toems_ApiCalls
{
    public class MessageModuleAPI : BaseAPI<EntityMessageModule>
    {
        ...
        public MessageModuleAPI(string resource, ProtectedLocalStorage protectedLocalStorage) : base(resource, protectedLocalStorage)
        {
        ...
        public List<EntityMessageModule> GetArchived(DtoSearchFilterCategories filter)
        {
            ...
            return _apiRequest.Execute<List<EntityMessageModule>>(Request);
        }
