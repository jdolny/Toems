...
namespace Toems_ApiCalls
{
    public class PolicyCategoryAPI : BaseAPI<EntityPolicyCategory>
    {
        ...
        public PolicyCategoryAPI(string resource, ProtectedLocalStorage protectedLocalStorage) : base(resource, protectedLocalStorage)
        {
        ...
        public DtoActionResult Post(List<EntityPolicyCategory> policyCategories)
        {
            ...
            Request.AddParameter("application/json", JsonConvert.SerializeObject(policyCategories), ParameterType.RequestBody);
