...
namespace Toems_ApiCalls
{
    public class WuModuleAPI : BaseAPI<EntityWuModule>
    {
        ...
        public WuModuleAPI(string resource, ProtectedLocalStorage protectedLocalStorage) : base(resource, protectedLocalStorage)
        {
        ...
        public List<EntityWuModule> GetArchived(DtoSearchFilterCategories filter)
        {
            ...
            return _apiRequest.Execute<List<EntityWuModule>>(Request);
        }
