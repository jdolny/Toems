...
namespace Toems_ServiceCore.Infrastructure
{
    ...
    public class ServiceClientPartitionSchema(ServiceClientPartition clientPartitionService)
    {
        ...
        private ILog log = LogManager.GetLogger(typeof(ServiceClientPartitionSchema));

        public void SetImageSchema(int hdToGet, string newHdSize, ImageProfileWithImage imageProfile,
