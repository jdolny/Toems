...
namespace Toems_Service
{
    ...
    {
        public string GetToken(string username, string password, string baseUrl, string verificationCode = null)
        {
            ...
            var result = new APICall().TokenApi.Get(username, password, verificationCode);
