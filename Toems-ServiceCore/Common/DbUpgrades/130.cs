...
namespace Toems_Common.DbUpgrades
{
    class _130 : IDbScript
    {
        ...
        {
            return
@"UPDATE `toems_version` SET `expected_app_version` = '1.3.0.0', `database_version` = '1.3.0.0', `expected_toecapi_version` = '1.3.0.0', `latest_client_version` = '1.3.0.0' WHERE (`toems_version_id` = '1');
