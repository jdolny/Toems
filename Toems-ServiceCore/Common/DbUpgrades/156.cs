...
namespace Toems_Common.DbUpgrades
{
    class _156 : IDbScript
    {
        ...
        {
            return
@"UPDATE `toems_version` SET `expected_app_version` = '1.5.6.0', `database_version` = '1.5.6.0', `expected_toecapi_version` = '1.5.6.0', `latest_client_version` = '1.5.6.0' WHERE (`toems_version_id` = '1');
