...
{
    public class UnitOfWork(ToemsDbContext _context) : IUnitOfWork
    {
        ...
        private RawSqlRepository _rawSqlRepository;
        ...
        public RawSqlRepository RawSqlRepository
        {
            get {return _rawSqlRepository ?? (_rawSqlRepository = new RawSqlRepository(_context)); }
        }

        public ReportRepository ReportRepository
        {
            get {return _reportRepository ?? (_reportRepository = new ReportRepository(_context)); }
        }
