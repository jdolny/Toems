...
public class ToemsDbContext : IdentityDbContext<AppUser>
{
...
public class ToemsDbContextFactory : IDesignTimeDbContextFactory<ToemsDbContext>
{
    public ToemsDbContext CreateDbContext(string[] args)
    {
