...
using LogicalVolume = Toems_Common.Dto.imageschemabe.DtoLogicalVolume;
...

{
    ...
    /// </summary>
    public class ServiceClientPartition
    {
        private readonly ImageProfileWithImage _imageProfile;
        private readonly DtoImageSchema _imageSchema;
        private readonly ILog log = LogManager.GetLogger(typeof(ServiceClientPartition));
        ...
        public DtoImageSchema GetImageSchema()
        {
            return _imageSchema;
        }
