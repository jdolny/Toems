...
namespace Toems_ApiCalls
{
    public class CommandModuleAPI : BaseAPI<EntityCommandModule>
    {
        ...
        public CommandModuleAPI(string resource, ProtectedLocalStorage protectedLocalStorage) : base(resource, protectedLocalStorage)
        {
        ...
        public List<EntityCommandModule> GetArchived(DtoSearchFilterCategories filter)
        {
            ...
            return _apiRequest.Execute<List<EntityCommandModule>>(Request);
        }
