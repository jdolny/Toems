...
namespace Toems_ApiCalls
{
    public class PrinterModuleAPI : BaseAPI<EntityPrinterModule>
    {
        ...
        public PrinterModuleAPI(string resource, ProtectedLocalStorage protectedLocalStorage) : base(resource, protectedLocalStorage)
        {
        ...
        public List<EntityPrinterModule> GetArchived(DtoSearchFilterCategories filter)
        {
            ...
            return _apiRequest.Execute<List<EntityPrinterModule>>(Request);
        }
    }
}