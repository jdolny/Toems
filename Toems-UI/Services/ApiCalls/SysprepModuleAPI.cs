...
namespace Toems_ApiCalls
{
    public class SysprepModuleAPI : BaseAPI<EntitySysprepModule>
    {
        ...
        public SysprepModuleAPI(string resource, ProtectedLocalStorage protectedLocalStorage) : base(resource, protectedLocalStorage)
        {
        ...
        public List<EntitySysprepModule> GetArchived(DtoSearchFilterCategories filter)
        {
            ...
            return _apiRequest.Execute<List<EntitySysprepModule>>(Request);
        }
